...
const artDescThaiBox = (
  <p>
    <span>Тайський бокс або Муай Тай</span> — це бойове мистецтво Таїланду, яке
    використовує удари кулаками, ліктями, колінами та гомілками, відоме своєю
    інтенсивністю та ефективністю в ближньому бою.
  </p>
);
...
const art = <span>тайського боксу</span>;
...
export default function Thaibox() {
