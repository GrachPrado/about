...
const artDescMMA_Childred = (
  <p>
    <span>ММА для дітей</span> — це програма тренувань, яка включає елементи
    різних бойових мистецтв, таких як боротьба, дзюдо, бразильське джиу-джитсу
    та кікбоксинг, з акцентом на безпеку, розвиток фізичних навичок, дисципліну
    та самозахист.
  </p>
);
...
const art = <span>ММА для дітей</span>;
...
export default function MMAChildren() {
